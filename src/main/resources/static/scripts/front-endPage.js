            ...
            var buttonTfoot = "<tr>"+
	            "<td  colspan='"+_this.options.title.length+"'>"+
	                "<div style='float:right;margin-left:10px;' class='tfootRight'>"+
	                    "<input placeholder='输入页码' type='number'>"+
	                    "<button>确定</button>"+
	                    "</div>"+
	            ...
	            "<td>"+
            "<tr>";
            _this.$element.html("<table class='table table-striped'><thead>"+titlelistBox+"</thead><tbody>"+histroy_DDBox+"</tbody><tfoot>"+buttonTfoot+"</tfoot></table>");
