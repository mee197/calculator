...
function generate() {
	...
	var win = window.open('');
	win.document.write(
		"<html><head><title>试卷(请选择“文件|打印...”)</title>" +
		"<style>.tb { width:980px; }\n.tb td { padding:8px; font-size:28px; }\n.hd { width:980px; border-bottom:1px solid #9F9F9F; margin-bottom:12px; }\n" +
		".tt { float:left; }\n.flds { float:right; font-size:21px; font-weight:bold; }\n.fld { float:left; width:180px; text-align:left; }</style></head><body>" +
		"<div class='hd'><div class='tt'>" + i + " 题</div><div class='flds'><div class='nm fld'>姓名:</div><div class='cls fld'>班级:</div><div class='sc fld'>分数:</div><div style='clear:both;'></div></div><div style='clear:both;'></div></div>" +
		html + "</body></html>");
	win.document.close();
}
